<template>
  ...
  <div class="container">
    <div class="row mt-lg-n12 mt-md-n12 mt-n10 justify-content-center">
      <div class="mx-auto col-xl-6 col-lg-7 col-md-8">
        <div class="card z-index-0">
          ...
          <div class="card-body grid gap-6 mb-6 sm:grid-cols-2">
            <form role="form">
              <div class="mb-3">
                <soft-input id="uid" type="text" placeholder="ID" :value="uid.value" :success="uid.valid == 1" :error="uid.valid == 2" @searchchange="searchChangeFunc" />
              </div>
              <div class="mb-3">
                <soft-input
                  id="email"
              ...
              <div class="mb-3">
                <soft-input
                  ...
                  aria-label="Nickname"
                  :value="name.value"
                  :success="name.valid == 1"
                  :error="name.valid == 2"
                  @searchchange="searchChangeFunc"
                />
              </div>
              <soft-checkbox id="flexCheckDefault" name="flexCheckDefault" class="font-weight-light" @checkboxclick="checkboxclick">
                I agree the
                <a href="javascript:;" class="text-dark font-weight-bolder">Terms and Conditions</a>
              </soft-checkbox>

              <div class="text-center">
                <soft-button color="dark" full-width variant="gradient" class="my-4 mb-2" :disable="!validAll" @click.prevent="signUp">Sign up</soft-button>
              </div>
              <p class="text-sm mt-3 mb-0">
                Already have an account?
                <router-link :to="{ name: 'Sign In' }" class="text-dark font-weight-bolder"> Sign in </router-link>
              </p>
            </form>
          </div>
        </div>
